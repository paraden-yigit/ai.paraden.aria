...
// Multi-select option lists, matching the company create form's dropdowns.
...
const HEADCOUNT_RANGES: { label: string; min: number; max?: number }[] = [
...
const HEADCOUNT_RANGE_LABELS = HEADCOUNT_RANGES.map((r) => r.label)
