        ...
        return (
          ...
          >
            ...
            <CardHeader className="flex-row items-center gap-3 space-y-0">
              ...
              {/* Pinned to the top-right corner so it mirrors the thumbnail on
                  the left; the box matches the thumbnail's size-11 footprint so
                  the two sit at the same vertical level on opposite edges. */}
